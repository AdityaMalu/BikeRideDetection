...
class BikeModeRepositoryImplTest {
    ...
    @Test
    fun `observeBikeMode should return flow from data store`() =
        runTest {
    ...
    @Test
    fun `getBikeMode should return bike mode from data store`() =
        runTest {
            val bikeMode = BikeMode(isEnabled = true, autoReplyMessage = "Test")
    ...
    @Test
    fun `setBikeModeEnabled should call data store`() =
        runTest {
    ...
    @Test
    fun `setAutoReplyMessage should call data store`() =
        runTest {
